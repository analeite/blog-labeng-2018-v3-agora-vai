...
<!--CSS-->
<link href="public/css/imagens.css" rel="stylesheet" type="text/css" />
...
<body class="background">
	...
	<div class="card text-center">
		...
		<img class="img-title" src="public/imagens/editado-2.png" alt="" />
		<!--<img class="img-title" src="public/imagens/tumblr_olvtwz6TZX1vwlpt9o5_1280.jpg" alt=""/>-->
		<div class="card-img-overlay">
			<br> <br> <br> <br>
			<p class="font-title">BLOG "MAIS UM DIA"</p>
			<h4 class="card-text font-sub">Aprendi que existem coisas boas
				no mundo, se você procurar por elas.</h4>
		</div>
	</div>
